<template>
  <label
    :class="[
      `${$clsPrefix}-checkbox`,
      border && checkboxSize ? `${$clsPrefix}-checkbox--` + checkboxSize : '',
  ...
  >
    <span 
      ...
      `${$clsPrefix}-checkbox__input`,
      {
       ...
       aria-checked="mixed"
    >
      <span :class="[`${$clsPrefix}-checkbox__inner`]" ></span>
      <input
        v-if="trueLabel || falseLabel"
        :class="[`${$clsPrefix}-checkbox__original`]"
        type="checkbox"
        :name="name"
        :disabled="isDisabled"
    ...
    <span :class="[`${$clsPrefix}-checkbox__label`]" v-if="$slots.default || label" >
      <slot></slot>
