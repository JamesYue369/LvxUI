...
```html
<template>
  <lvx-transfer v-model="value1" :data="data"></lvx-transfer>
</template>
...
<template>
  <lvx-transfer
    ...
    @change="handleChange"
    :data="data">
    <lvx-button class="transfer-footer" slot="left-footer" size="small">操作</lvx-button>
    <lvx-button class="transfer-footer" slot="right-footer" size="small">操作</lvx-button>
  </lvx-transfer>
</template>
