...
```html
<template>
  <lvx-button :plain="true" @click="open">打开消息提示</lvx-button>
  <lvx-button :plain="true" @click="openVn">VNode</lvx-button>
</template>
...
```html
<template>
  <lvx-button :plain="true" @click="open5">消息</lvx-button>
  <lvx-button :plain="true" @click="open6">成功</lvx-button>
  <lvx-button :plain="true" @click="open7">警告</lvx-button>
  <lvx-button :plain="true" @click="open8">错误</lvx-button>
</template>
...
```html
<template>
  <lvx-button :plain="true" @click="openCenter">文字居中</lvx-button>
</template>
...
```html
<template>
  <lvx-button :plain="true" @click="openHTML">使用 HTML 片段</lvx-button>
</template>
